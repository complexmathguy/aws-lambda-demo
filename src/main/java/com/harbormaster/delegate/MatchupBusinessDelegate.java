 ...
 */
public class MatchupBusinessDelegate 
...
//************************************************************************
	...
	*/
    ...
    throws ProcessingException, IllegalArgumentException
    {
        ...
        {
            String errMsg = "MatchupBusinessDelegate:getMatchup( MatchupPrimaryKey key ) - unable to locate Matchup with key " + key.toString() + " - " + exc;
            LOGGER.warning( errMsg );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException
    {
        ...
        {
            String errMsg = "MatchupBusinessDelegate:createMatchup() - Unable to create Matchup" + exc;
            LOGGER.warning( errMsg );
            throw new ProcessingException( errMsg );
        }
        finally
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException
    {
        ...
        if ( key != null )
        {
            ...
            {
                String errMsg = "MatchupBusinessDelegate:saveMatchup() - Unable to save Matchup" + exc;
                LOGGER.warning( errMsg );
                throw new ProcessingException( errMsg  );
            }
            finally
    ...
    */
    ...
    {    	
        ...
        {
            String errMsg = msgPrefix + "Unable to delete Matchup using key = "  + key + ". " + exc;
            LOGGER.warning( errMsg );
            throw new ProcessingException( errMsg );
        }
        finally
