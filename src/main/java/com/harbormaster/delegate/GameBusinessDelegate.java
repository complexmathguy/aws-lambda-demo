...
//************************************************************************
	...
	*/
    ...
    throws ProcessingException, IllegalArgumentException
    {
        ...
        {
            String errMsg = "GameBusinessDelegate:getGame( GamePrimaryKey key ) - unable to locate Game with key " + key.toString() + " - " + exc;
            LOGGER.warning( errMsg );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException
    {
        ...
        {
            String errMsg = "GameBusinessDelegate:createGame() - Unable to create Game" + exc;
            LOGGER.warning( errMsg );
            throw new ProcessingException( errMsg );
        }
        finally
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException
    {
        ...
        if ( key != null )
        {
            ...
            {
                String errMsg = "GameBusinessDelegate:saveGame() - Unable to save Game" + exc;
                LOGGER.warning( errMsg );
                throw new ProcessingException( errMsg  );
            }
            finally
    ...
    */
    ...
    {    	
        ...
        {
            String errMsg = msgPrefix + "Unable to delete Game using key = "  + key + ". " + exc;
            LOGGER.warning( errMsg );
            throw new ProcessingException( errMsg );
        }
        finally
