 ...
 */
public class PlayerBusinessDelegate 
...
//************************************************************************
	...
	*/
    ...
    throws ProcessingException, IllegalArgumentException
    {
        ...
        {
            String errMsg = "PlayerBusinessDelegate:getPlayer( PlayerPrimaryKey key ) - unable to locate Player with key " + key.toString() + " - " + exc;
            LOGGER.warning( errMsg );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException
    {
        ...
        {
            String errMsg = "PlayerBusinessDelegate:createPlayer() - Unable to create Player" + exc;
            LOGGER.warning( errMsg );
            throw new ProcessingException( errMsg );
        }
        finally
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException
    {
        ...
        if ( key != null )
        {
            ...
            {
                String errMsg = "PlayerBusinessDelegate:savePlayer() - Unable to save Player" + exc;
                LOGGER.warning( errMsg );
                throw new ProcessingException( errMsg  );
            }
            finally
    ...
    */
    ...
    {    	
        ...
        {
            String errMsg = msgPrefix + "Unable to delete Player using key = "  + key + ". " + exc;
            LOGGER.warning( errMsg );
            throw new ProcessingException( errMsg );
        }
        finally
