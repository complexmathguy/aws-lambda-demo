 ...
 */
public class LeagueBusinessDelegate 
...
//************************************************************************
	...
	*/
    ...
    throws ProcessingException, IllegalArgumentException
    {
        ...
        {
            String errMsg = "LeagueBusinessDelegate:getLeague( LeaguePrimaryKey key ) - unable to locate League with key " + key.toString() + " - " + exc;
            LOGGER.warning( errMsg );
     ...
     */
    public ArrayList<League> getAllLeague() 
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException
    {
        ...
        {
            String errMsg = "LeagueBusinessDelegate:createLeague() - Unable to create League" + exc;
            LOGGER.warning( errMsg );
            throw new ProcessingException( errMsg );
        }
        finally
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException
    {
        ...
        if ( key != null )
        {
            ...
            {
                String errMsg = "LeagueBusinessDelegate:saveLeague() - Unable to save League" + exc;
                LOGGER.warning( errMsg );
                throw new ProcessingException( errMsg  );
            }
            finally
    ...
    */
    ...
    {    	
        ...
        {
            String errMsg = msgPrefix + "Unable to delete League using key = "  + key + ". " + exc;
            LOGGER.warning( errMsg );
            throw new ProcessingException( errMsg );
        }
        finally
