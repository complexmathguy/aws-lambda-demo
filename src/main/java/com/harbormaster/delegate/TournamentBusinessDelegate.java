 ...
 */
public class TournamentBusinessDelegate 
...
//************************************************************************
	...
	*/
    ...
    throws ProcessingException, IllegalArgumentException
    {
        ...
        {
            String errMsg = "TournamentBusinessDelegate:getTournament( TournamentPrimaryKey key ) - unable to locate Tournament with key " + key.toString() + " - " + exc;
            LOGGER.warning( errMsg );
     ...
     */
    public ArrayList<Tournament> getAllTournament() 
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException
    {
        ...
        {
            String errMsg = "TournamentBusinessDelegate:createTournament() - Unable to create Tournament" + exc;
            LOGGER.warning( errMsg );
            throw new ProcessingException( errMsg );
        }
        finally
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException
    {
        ...
        if ( key != null )
        {
            ...
            {
                String errMsg = "TournamentBusinessDelegate:saveTournament() - Unable to save Tournament" + exc;
                LOGGER.warning( errMsg );
                throw new ProcessingException( errMsg  );
            }
            finally
    ...
    */
    ...
    {    	
        ...
        {
            String errMsg = msgPrefix + "Unable to delete Tournament using key = "  + key + ". " + exc;
            LOGGER.warning( errMsg );
            throw new ProcessingException( errMsg );
        }
        finally
